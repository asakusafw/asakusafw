 ...
 * ex2を表すデータモデルクラス。
 */
@ColumnOrder(value = {"SID", "VALUE", "STRING"})@ModelInputLocation(Ex2Input.class)@ModelOutputLocation(Ex2Output.class)
        @OriginalName(value = "EX2")@PrimaryKey(value = {"sid"}) public class Ex2 implements DataModel<Ex2>, Writable {
