 ...
 */
@ColumnOrder(value = {"SID"})@ModelInputLocation(SystemColumnsInput.class)@ModelOutputLocation(SystemColumnsOutput.class
        )@OriginalName(value = "SYSTEM_COLUMNS") public class SystemColumns implements DataModel<SystemColumns>, 
        Writable {
