...
@ModelOutputLocation(SystemColumnsOutput.class)
@OriginalName(value = "SYSTEM_COLUMNS")
public class SystemColumns implements DataModel<SystemColumns>, Writable {
    ...
    @Override
    @SuppressWarnings("deprecation")
    public void copyFrom(SystemColumns other) {
