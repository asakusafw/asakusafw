 ...
 * ex1を表すデータモデルクラス。
 */
@ColumnOrder(value = {"SID", "VALUE", "STRING"})@ModelInputLocation(Ex1Input.class)@ModelOutputLocation(Ex1Output.class)
        @OriginalName(value = "EX1")@PrimaryKey(value = {"sid"}) public class Ex1 implements DataModel<Ex1>, Writable {
