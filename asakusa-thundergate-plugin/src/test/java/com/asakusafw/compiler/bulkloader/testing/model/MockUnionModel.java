...
@ModelOutputLocation(MockUnionModelOutput.class)
@OriginalName(value = "MOCK_UNION")
@PrimaryKey(value = { "a" })
public class MockUnionModel implements DataModel<MockUnionModel>, Writable {
    ...
    @Override
    @SuppressWarnings("deprecation")
    public void copyFrom(MockUnionModel other) {
     ...
     */
    @SuppressWarnings("deprecation")
    public void setXOption(IntOption option) {
