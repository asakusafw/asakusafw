 ...
 */
@ColumnOrder(value = {"A", "B", "C", "D", "X"})@ModelInputLocation(MockUnionModelInput.class)@ModelOutputLocation(
        MockUnionModelOutput.class)@OriginalName(value = "MOCK_UNION")@PrimaryKey(value = {"a"}) public class 
        MockUnionModel implements DataModel<MockUnionModel>, Writable {
