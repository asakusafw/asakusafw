...
@ModelOutputLocation(MockErrorModelOutput.class)
@OriginalName(value = "MOCK_ERROR")
@PrimaryKey(value = { "a" })
public class MockErrorModel implements DataModel<MockErrorModel>, Writable {
    ...
    @Override
    @SuppressWarnings("deprecation")
    public void copyFrom(MockErrorModel other) {
     ...
     */
    @SuppressWarnings("deprecation")
    public void setDOption(IntOption option) {
     ...
     * @return e
     */
    @OriginalName(value = "E")
    public IntOption getEOption() {
        return this.e;
    }
     ...
     */
    @SuppressWarnings("deprecation")
    public void setEOption(IntOption option) {
