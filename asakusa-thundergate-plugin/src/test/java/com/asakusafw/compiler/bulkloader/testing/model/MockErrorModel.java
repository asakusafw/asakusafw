 ...
 */
@ColumnOrder(value = {"A", "B", "C", "D", "E"})@ModelInputLocation(MockErrorModelInput.class)@ModelOutputLocation(
        MockErrorModelOutput.class)@OriginalName(value = "MOCK_ERROR")@PrimaryKey(value = {"a"}) public class 
        MockErrorModel implements DataModel<MockErrorModel>, Writable {
