...
public class StringBuilderSupport implements DataModelStreamSupport<StringBuilder> {
    ...
    @Override
    public DataModelReader<StringBuilder> createReader(InputStream stream) throws IOException {
    ...
    @Override
    public DataModelWriter<StringBuilder> createWriter(OutputStream stream) throws IOException {
