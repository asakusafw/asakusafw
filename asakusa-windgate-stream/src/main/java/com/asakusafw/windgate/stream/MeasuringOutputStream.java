...
/**
 * {@link OutputStream} with measuring bytes to write.
 * @since 0.2.2
 */
public final class MeasuringOutputStream extends OutputStream {
     ...
     */
    public MeasuringOutputStream(OutputStream stream) {
        if (stream == null) {
