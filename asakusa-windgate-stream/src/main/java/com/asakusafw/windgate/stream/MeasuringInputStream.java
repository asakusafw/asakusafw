...
/**
 * {@link InputStream} with measuring bytes to read.
 * @since 0.2.2
 */
public final class MeasuringInputStream extends InputStream {
     ...
     */
    public MeasuringInputStream(InputStream target) {
        if (target == null) {
