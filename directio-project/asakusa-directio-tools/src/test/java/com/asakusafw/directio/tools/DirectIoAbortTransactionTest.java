...
/**
 * Test for {@link DirectIoAbortTransaction}.
 */
public class DirectIoAbortTransactionTest extends DirectIoCommandTestRoot {
    ...
    public void run() throws Exception {
        ...
        assertThat(ToolRunner.run(conf, exec, new String[] {"__UNKNOWN__"}), is(1));
        assertThat(count(production1), is(0));
        assertThat(count(production2), is(0));
