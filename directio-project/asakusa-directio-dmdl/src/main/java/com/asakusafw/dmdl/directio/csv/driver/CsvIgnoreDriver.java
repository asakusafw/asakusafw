...
/**
 * Processes <code>&#64;directio.csv.ignore</code> attributes.
<h2>'&#64;directio.csv.ignore' attribute</h2>
...
public class CsvIgnoreDriver  extends PropertyAttributeDriver {
     ...
     * The attribute name.
     */
    public static final String TARGET_NAME = "directio.csv.ignore"; //$NON-NLS-1$
