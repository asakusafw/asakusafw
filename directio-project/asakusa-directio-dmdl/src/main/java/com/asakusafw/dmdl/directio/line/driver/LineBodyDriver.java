...
/**
 * Processes <code>&#64;directio.line.body</code> attributes.
<h2>'&#64;directio.line.body' attribute</h2>
...
public class LineBodyDriver extends PropertyAttributeDriver {
     ...
     * The attribute name.
     */
    public static final String TARGET_NAME = "directio.line.body"; //$NON-NLS-1$
    ...
    public void process(DmdlSemantics environment, PropertyDeclaration declaration, AstAttribute attribute) {
        ...
        if (LineFieldTrait.checkConflict(environment, declaration, attribute)) {
            declaration.putTrait(
                    ...
                    new LineFieldTrait(attribute, LineFieldTrait.Kind.BODY));
        }
    }
}
