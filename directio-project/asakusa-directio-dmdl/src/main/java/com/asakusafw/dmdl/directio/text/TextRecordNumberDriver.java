...
/**
 * Processes <code>&#64;directio.text.record_number</code> attributes.
 * @since 0.9.1
 * @see TextFormatConstants
 */
public class TextRecordNumberDriver extends PropertyAttributeDriver {
    ...
    public void process(DmdlSemantics environment, PropertyDeclaration declaration, AstAttribute attribute) {
        ...
        TextFieldTrait.register(
                ...
                new TextFieldTrait(attribute, TextFieldTrait.Kind.RECORD_NUMBER));
    }
