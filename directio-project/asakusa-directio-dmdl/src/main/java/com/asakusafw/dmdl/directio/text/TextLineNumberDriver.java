...
/**
 * Processes <code>&#64;directio.text.line_number</code> attributes.
 * @since 0.9.1
 * @see TextFormatConstants
 */
public class TextLineNumberDriver extends PropertyAttributeDriver {
    ...
    public void process(DmdlSemantics environment, PropertyDeclaration declaration, AstAttribute attribute) {
        ...
        TextFieldTrait.register(
                ...
                new TextFieldTrait(attribute, TextFieldTrait.Kind.LINE_NUMBER));
    }
