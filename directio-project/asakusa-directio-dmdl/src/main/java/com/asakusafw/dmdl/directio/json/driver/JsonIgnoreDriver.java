...
/**
 * Processes <code>&#64;directio.json.ignore</code> attributes.
 * @since 0.10.3
 * @see JsonFormatConstants
 */
public class JsonIgnoreDriver extends PropertyAttributeDriver {

    @Override
    public String getTargetName() {
        return ATTRIBUTE_IGNORED_FIELD;
    }
    ...
    public void process(DmdlSemantics environment, PropertyDeclaration declaration, AstAttribute attribute) {
        ...
        JsonPropertyTrait.register(
                ...
                new JsonPropertyTrait(attribute, JsonPropertyTrait.Kind.IGNORE));
    }
}
