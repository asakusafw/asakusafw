...
/**
 * Processes <code>&#64;directio.json.record_number</code> attributes.
 * @since 0.10.3
 * @see JsonFormatConstants
 */
public class JsonRecordNumberDriver extends PropertyAttributeDriver {

    @Override
    public String getTargetName() {
        return ATTRIBUTE_RECORD_NUMBER_FIELD;
    }
    ...
    public void process(DmdlSemantics environment, PropertyDeclaration declaration, AstAttribute attribute) {
        ...
        JsonPropertyTrait.register(
                ...
                new JsonPropertyTrait(attribute, JsonPropertyTrait.Kind.RECORD_NUMBER));
    }
