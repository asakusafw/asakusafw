...
/**
 * Processes <code>&#64;directio.json.file_name</code> attributes.
 * @since 0.10.3
 * @see JsonFormatConstants
 */
public class JsonFileNameDriver extends PropertyAttributeDriver {
    ...
    public void process(DmdlSemantics environment, PropertyDeclaration declaration, AstAttribute attribute) {
        ...
        JsonPropertyTrait.register(
                ...
                new JsonPropertyTrait(attribute, JsonPropertyTrait.Kind.FILE_NAME));
    }
