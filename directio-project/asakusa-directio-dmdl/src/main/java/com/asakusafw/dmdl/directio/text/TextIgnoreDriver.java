...
/**
 * Processes <code>&#64;directio.text.ignore</code> attributes.
 * @since 0.9.1
 * @see TextFormatConstants
 */
public class TextIgnoreDriver extends PropertyAttributeDriver {
    ...
    public void process(DmdlSemantics environment, PropertyDeclaration declaration, AstAttribute attribute) {
        ...
        TextFieldTrait.register(
                ...
                new TextFieldTrait(attribute, TextFieldTrait.Kind.IGNORE));
    }
}
