 ...
 */
public final class SimpleJdbcSupport implements DataModelJdbcSupport<Simple> {
    ...
    @Override public Class<Simple> getSupportedType() {
        return Simple.class;
    }
    ...
    @Override public DataModelJdbcSupport.DataModelResultSet<Simple> createResultSetSupport(ResultSet resultSet, List<
            String> columnNames) {
        if(resultSet == null) {
    ...
    @Override public DataModelJdbcSupport.DataModelPreparedStatement<Simple> createPreparedStatementSupport(
    ...
    private static final class ResultSetSupport implements DataModelJdbcSupport.DataModelResultSet<Simple> {
        ...
        @Override public boolean next(Simple object) throws SQLException {
    ...
    private static final class PreparedStatementSupport implements DataModelJdbcSupport.DataModelPreparedStatement<
            Simple> {
        ...
        @Override public void setParameters(Simple object) throws SQLException {
            if(properties[0]!= 0) {
