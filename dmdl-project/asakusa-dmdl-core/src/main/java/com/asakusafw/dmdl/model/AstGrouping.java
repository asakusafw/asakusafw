 ...
 * @since 0.2.0
 */
public class AstGrouping extends AbstractAstNode {
     ...
     */
    public final List<AstSimpleName> properties;

    /**
     * Creates and returns a new instance.
     * @param region the region of this node on the enclosing script, or {@code null} if unknown
     * @param properties the names of grouping properties
     * @throws IllegalArgumentException if some parameters were {@code null}
     */
    public AstGrouping(Region region, List<AstSimpleName> properties) {
        if (properties == null) {
    ...
    public <C, R> R accept(C context, AstNode.Visitor<C, R> visitor) {
        ...
        R result = visitor.visitGrouping(context, this);
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        AstGrouping other = (AstGrouping) obj;
