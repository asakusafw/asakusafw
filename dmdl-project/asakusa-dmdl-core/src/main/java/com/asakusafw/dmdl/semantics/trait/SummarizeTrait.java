 ...
 */
public class SummarizeTrait implements Trait<SummarizeTrait> {

    private final AstExpression<AstSummarize> expression;

    private final List<ReduceTerm<AstSummarize>> terms;

    /**
     * Creates and returns a new instance.
     * @param expression the original AST
     * @param terms the summarize terms
     * @throws IllegalArgumentException if some parameters were {@code null}
     */
    public SummarizeTrait(AstExpression<AstSummarize> expression, List<ReduceTerm<AstSummarize>> terms) {
        if (expression == null) {
    ...
    @Override
    public AstExpression<AstSummarize> getOriginalAst() {
        return expression;
    }
     ...
     * @return the terms
     */
    public List<ReduceTerm<AstSummarize>> getTerms() {
        return terms;
    }
}
