...
public class AstPropertyFolding extends AbstractAstNode {
    ...
    public <C, R> R accept(C context, AstNode.Visitor<C, R> visitor) {
        ...
        R result = visitor.visitPropertyFolding(context, this);
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        AstPropertyFolding other = (AstPropertyFolding) obj;
        if (!aggregator.equals(other.aggregator)) {
            return false;
        }
