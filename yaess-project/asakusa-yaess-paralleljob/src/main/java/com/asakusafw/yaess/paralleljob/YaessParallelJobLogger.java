 ...
 * @since 0.2.6
 */
public class YaessParallelJobLogger extends YaessLogger {

    private static final ResourceBundle BUNDLE = ResourceBundle.getBundle(
            "com.asakusafw.yaess.paralleljob.log"); //$NON-NLS-1$
     ...
     */
    public YaessParallelJobLogger(Class<?> target) {
        super(target, "PARALLELJOB");
    }
