...
import ${package}.modelgen.dmdl.model.ImCategorySummary;
...
public abstract class CategorySummaryOperator {
     ...
     */
    @Summarize
    public abstract ImCategorySummary summarizeByCategory(JoinedSalesInfo info);
