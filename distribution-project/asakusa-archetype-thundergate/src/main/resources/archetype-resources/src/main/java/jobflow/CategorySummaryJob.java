...
public class CategorySummaryJob extends FlowDescription {
    ...
    public CategorySummaryJob(
            @Import(name = "salesDetail", description = SalesDetailFromJdbc.class)
            In<SalesDetail> salesDetail,
            @Import(name = "storeInfo", description = StoreInfoFromJdbc.class)
            In<StoreInfo> storeInfo,
            @Import(name = "itemInfo", description = ItemInfoFromJdbc.class)
            In<ItemInfo> itemInfo,
            @Export(name = "categorySummary", description = CategorySummaryToJdbc.class)
            Out<CategorySummary> categorySummary,
            @Export(name = "errorRecord", description = ErrorRecordToJdbc.class)
    ...
    protected void describe() {
        ...
        // 集計結果を変換して出力
        Extend<CategorySummary> extendCategory = core.extend(summarize.out, CategorySummary.class);
        categorySummary.add(extendCategory.out);
