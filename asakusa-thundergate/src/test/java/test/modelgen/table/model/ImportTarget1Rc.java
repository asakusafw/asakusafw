...
/**
 * テーブル<code>import_target1_rc</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "import_target1_rc", columns = {"SID",
            "CACHE_FILE_SID", "CREATE_DATETIME"}, primary = {"SID"})@SuppressWarnings("deprecation") public class
        ImportTarget1Rc implements Writable {
    /**
     ...
     */
    public void copyFrom(ImportTarget1Rc source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        ImportTarget1Rc other = (ImportTarget1Rc) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=import_target1_rc");
        result.append(", sid=");
