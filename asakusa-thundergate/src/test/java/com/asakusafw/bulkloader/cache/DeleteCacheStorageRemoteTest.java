...
/**
 * Test for {@link DeleteCacheStorageRemote}.
 */
public class DeleteCacheStorageRemoteTest {
    ...
    private final DeleteCacheStorageRemote service = new DeleteCacheStorageRemote();
    ...
    private FileList.Reader prepare(String... locations) throws IOException {
        ...
        for (String location : locations) {
            writer.openNext(new FileProtocol(FileProtocol.Kind.DELETE_CACHE, qualify(location), null)).close();
        }
        writer.close();
