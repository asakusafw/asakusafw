 ...
 * @since 0.2.3
 */
public class JdbcLogger extends WindGateLogger {

    private static final ResourceBundle BUNDLE = ResourceBundle.getBundle("com.asakusafw.windgate.jdbc.log"); //$NON-NLS-1$
     ...
     */
    public JdbcLogger(Class<?> target) {
        super(target, "JDBC");
    }
