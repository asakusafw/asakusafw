 ...
 */
public final class Line2Input implements ModelInput<Line2> {
     ...
     */
    public Line2Input(RecordParser parser) {
        if(parser == null) {
            throw new IllegalArgumentException("parser");
        }
        this.parser = parser;
    }
    @Override public boolean readTo(Line2 model) throws IOException {
