...
import com.asakusafw.compiler.directio.testing.io.Line2Input;
import com.asakusafw.compiler.directio.testing.io.Line2Output;
 ...
 * line2を表すデータモデルクラス。
 */
@DataModelKind("DMDL")@ModelInputLocation(Line2Input.class)@ModelOutputLocation(Line2Output.class)@PropertyOrder({
            "value", "first", "position", "length"}) public class Line2 implements DataModel<Line2>, Line, Writable {
    ...
    @Override@SuppressWarnings("deprecation") public void copyFrom(Line2 other) {
