...
/**
 * Jobflow with empty name for input.
 */
@JobFlow(name = "testing")
public class WithEmptyInputName extends FlowDescription {
     ...
     * @param out output
     */
    public WithEmptyInputName(
            @Import(name = "", description = MockHogeImporterDescription.class)
            In<MockHoge> in,
