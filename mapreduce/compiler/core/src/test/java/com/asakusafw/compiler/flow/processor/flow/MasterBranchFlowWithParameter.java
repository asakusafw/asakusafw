...
import com.asakusafw.compiler.flow.processor.operator.MasterBranchFlowFactory.WithParameter;
...
public class MasterBranchFlowWithParameter extends FlowDescription {
     ...
     */
    public MasterBranchFlowWithParameter(
