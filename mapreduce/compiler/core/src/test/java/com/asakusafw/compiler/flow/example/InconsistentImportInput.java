...
/**
 * A jobflow class w/ inconsistent input type.
 */
@JobFlow(name = "testing")
public class InconsistentImportInput extends FlowDescription {
     ...
     * @param out output
     */
    public InconsistentImportInput(
            @Import(name = "hoge", description = MockFooImporterDescription.class)
            In<MockHoge> in,
