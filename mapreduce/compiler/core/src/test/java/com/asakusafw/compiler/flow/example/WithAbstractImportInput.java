...
/**
 * A jobflow which has input w/ abstract importer class.
 */
@JobFlow(name = "testing")
public class WithAbstractImportInput extends FlowDescription {
     ...
     * @param out output
     */
    public WithAbstractImportInput(
            @Import(name = "hoge", description = AbstractImporterDescription.class)
            In<MockHoge> in,
