...
import com.asakusafw.compiler.flow.processor.operator.MasterJoinFlowFactory.RenameKey;
...
import com.asakusafw.compiler.flow.testing.external.ExJoined2MockExporterDescription;
...
public class MasterJoinFlowRenameKey extends FlowDescription {

    private In<Ex1> in1;

    private In<Ex2> in2;

    private Out<ExJoined2> out1;
