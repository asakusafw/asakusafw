...
import com.asakusafw.compiler.flow.processor.operator.MasterBranchFlowFactory.Selection;
...
public class MasterBranchFlowSelection extends FlowDescription {
     ...
     */
    public MasterBranchFlowSelection(
