...
import com.asakusafw.compiler.flow.processor.operator.LoggingFlowFactory.WithParameter;
...
/**
 * test for {@link LoggingFlowProcessor}.
 */
@JobFlow(name = "testing")
public class LoggingFlowWithParameter extends FlowDescription {
     ...
     * @param out1 output
     */
    public LoggingFlowWithParameter(
