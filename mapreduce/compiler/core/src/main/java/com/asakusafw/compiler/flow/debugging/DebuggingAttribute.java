 ...
 * @since 0.4.0
 */
class DebuggingAttribute implements FlowElementAttribute {

    final LinePartProcessor processor;

    DebuggingAttribute(LinePartProcessor processor) {
        this.processor = processor;
    }

    @Override
    public Class<? extends FlowElementAttribute> getDeclaringClass() {
        return DebuggingAttribute.class;
    }
}
