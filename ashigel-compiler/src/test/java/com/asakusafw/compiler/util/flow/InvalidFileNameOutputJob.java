 ...
 */
package com.asakusafw.compiler.util.flow;
 ...
 */
@JobFlow(name = "job")
public class InvalidFileNameOutputJob extends FlowDescription {
     ...
     */
    public InvalidFileNameOutputJob(
            @Import(name = "input", description = Ex1MockImporterDescription.class)
            In<Ex1> input,
            @Export(name = "output", description = InvalidFileNameExporterDesc.class)
            Out<Ex1> output) {
        this.input = input;
        this.output = output;
    }
