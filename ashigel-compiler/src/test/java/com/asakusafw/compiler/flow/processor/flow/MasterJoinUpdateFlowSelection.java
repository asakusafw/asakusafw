...
import com.asakusafw.compiler.flow.processor.operator.MasterJoinUpdateFlowFactory.Selection;
...
public class MasterJoinUpdateFlowSelection extends FlowDescription {
     ...
     * @param out2 出力2
     */
    public MasterJoinUpdateFlowSelection(
