    ...
    public void single() {
        ...
        Slot slot = new Slot(
                ...
                Arrays.asList(new Slot.Input[] {
                        new Slot.Input(Location.fromPath("a", '/'), SequenceFileInputFormat.class),
                }),
    ...
    public void multiple() {
        ...
        List<Slot> slots = Arrays.asList(new Slot[] {
                new Slot(
                        ...
                        Arrays.asList("sid"),
                        Arrays.asList(new Slot.Input[] {
                                new Slot.Input(Location.fromPath("a/1", '/'), SequenceFileInputFormat.class),
                        }),
                        SequenceFileOutputFormat.class),
                new Slot(
                        "out2",
                        ...
                        Arrays.asList("sid"),
                        Arrays.asList(new Slot.Input[] {
                                new Slot.Input(Location.fromPath("a/2", '/'), SequenceFileInputFormat.class),
                        }),
                        SequenceFileOutputFormat.class),
                new Slot(
                        "out3",
                        ...
                        Arrays.asList("sid"),
                        Arrays.asList(new Slot.Input[] {
                                new Slot.Input(Location.fromPath("a/3", '/'), SequenceFileInputFormat.class),
                        }),
                        SequenceFileOutputFormat.class),
        });
