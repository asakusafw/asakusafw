...
/**
 * テーブル<code>EX1</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")
@DataModel
@TableModel(name = "EX1", columns = { "SID", "VALUE", "STRING",
        "LAST_UPDATE_TIME", "JOBFLOW_SID", "CACHE_FILE_SID" }, primary = { "SID" })
@SuppressWarnings("deprecation")
public class Ex1 implements Writable {
    /**
     ...
     *            コピー元になるオブジェクト
     */
    public void copyFrom(Ex1 source) {
    ...
    public String toString() {
        return "Ex1 [sid=" + sid + ", value=" + value + ", string=" + string
                + ", lastUpdateTime=" + lastUpdateTime + ", jobflowSid="
                + jobflowSid + ", cacheFileSid=" + cacheFileSid + "]";
    }
}