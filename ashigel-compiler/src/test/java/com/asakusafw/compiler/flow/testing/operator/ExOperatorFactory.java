...
@Generated("OperatorFactoryClassGenerator:0.0.1") public class ExOperatorFactory {
    ...
    public static final class FoldAdd implements Operator {
        ...
        FoldAdd(Source<Ex1> in) {
            OperatorDescription.Builder builder2 = new OperatorDescription.Builder(Fold.class);
            builder2.declare(ExOperator.class, ExOperatorImpl.class, "foldAdd");
            builder2.declareParameter(Ex1.class);
            builder2.declareParameter(Ex1.class);
            builder2.addInput("in", in, new ShuffleKey(Arrays.asList(new String[]{"STRING"}), Arrays.asList(new 
                    ShuffleKey.Order[]{})));
            builder2.addOutput("out", in);
         ...
         * @throws IllegalArgumentException 引数に{@code null}が指定された場合
         */
        public ExOperatorFactory.FoldAdd as(String newName2) {
    ...
    public static final class Branch implements Operator {
        ...
        Branch(Source<Ex1> model) {
            ...
            builder7.addInput("model", model);
            builder7.addOutput("yes", model);
            builder7.addOutput("no", model);
            builder7.addOutput("cancel", model);
