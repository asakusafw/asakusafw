...
@Joined(terms = {
        @Joined.Term(source = Ex1.class, mappings = { @Joined.Mapping(source = "sid", destination = "sid1"),
                @Joined.Mapping(source = "value", destination = "key") }, shuffle = @Key(group = { "value" })),
        @Joined.Term(source = Ex2.class, mappings = { @Joined.Mapping(source = "sid", destination = "sid2"),
                @Joined.Mapping(source = "value", destination = "key") }, shuffle = @Key(group = { "value" })) })
@ModelInputLocation(ExJoined2Input.class)
@ModelOutputLocation(ExJoined2Output.class)
public class ExJoined2 implements DataModel<ExJoined2>, Writable {
    ...
    @Override
    @SuppressWarnings("deprecation")
    public void copyFrom(ExJoined2 other) {
     ...
     */
    @SuppressWarnings("deprecation")
    public void setSid1(long value) {
     ...
     */
    @SuppressWarnings("deprecation")
    public void setSid1Option(LongOption option) {
     ...
     */
    @SuppressWarnings("deprecation")
    public void setSid2(long value) {
     ...
     */
    @SuppressWarnings("deprecation")
    public void setSid2Option(LongOption option) {
