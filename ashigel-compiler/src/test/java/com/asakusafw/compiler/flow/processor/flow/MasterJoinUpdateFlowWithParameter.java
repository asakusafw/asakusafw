...
import com.asakusafw.compiler.flow.processor.operator.MasterJoinUpdateFlowFactory.WithParameter;
...
/**
 * {@link MasterJoinUpdateFlowProcessor}のテスト。
 */
@JobFlow(name = "testing")
public class MasterJoinUpdateFlowWithParameter extends FlowDescription {
     ...
     * @param out2 出力2
     */
    public MasterJoinUpdateFlowWithParameter(
