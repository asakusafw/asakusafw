...
/**
 * Processes <code>&#64;directio.tsv.ignore</code> attributes.
<h2>'&#64;directio.tsv.ignore' attribute</h2>
The attributed declaration must have no attributes.
 * @since 0.5.2
 */
public class TsvIgnoreDriver  extends PropertyAttributeDriver {

    /**
     * The attribute name.
     */
    public static final String TARGET_NAME = "directio.tsv.ignore"; //$NON-NLS-1$
