...
/**
 * An implementation of {@link ValueDriver} for {@link StringOption}.
 * @since 0.7.0
 */
public class StringOptionDriver extends AbstractValueDriver {
     ...
     */
    public StringOptionDriver(StringObjectInspector inspector) {
