 ...
 */
package com.asakusafw.directio.hive.orc.v1;
...
public class CompatibilityV1 extends Compatibility {
    ...
    protected Map<String, String> collectPropertyMap(OrcFormatConfiguration format) {
        ...
        putTableProperty(properties, OrcTableProperties.COMPRESSION, format.getCompressionKind());
        putTableProperty(properties, OrcTableProperties.STRIPE_SIZE, format.getStripeSize());
        return properties;
    }

    private static void putTableProperty(Map<String, String> results, OrcTableProperties property, Object value) {
        if (value == null) {
            return;
        }
    ...
    public <T> ModelOutput<T> createOutput(
        ...
        OrcFile.Version formatVersion = conf.getFormatVersion(OrcFile.Version.class);
