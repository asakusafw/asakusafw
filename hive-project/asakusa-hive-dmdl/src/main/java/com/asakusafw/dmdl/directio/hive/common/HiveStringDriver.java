...
/**
 * Processes <code>&#64;directio.hive.string</code> attributes.
<h2>'&#64;directio.hive.string' attribute</h2>
The attributed declaration must be without any properties.
 * @since 0.7.0
 */
public class HiveStringDriver extends PropertyAttributeDriver {

    /**
     * The attribute name.
     */
    public static final String TARGET_NAME = "directio.hive.string"; //$NON-NLS-1$
    ...
    public void process(
        ...
        if (Util.checkProperty(environment, declaration, attribute, HiveFieldTrait.TypeKind.STRING) == false) {
            return;
        }
