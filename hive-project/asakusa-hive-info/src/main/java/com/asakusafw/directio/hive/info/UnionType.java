 ...
 * Type category must be {@link com.asakusafw.directio.hive.info.FieldType.Category#UNION}.
 * @since 0.8.1
 */
public class UnionType implements FieldType {
    ...
    UnionType(
            ...
            @JsonProperty(value = K_ELEMENTS, required = true) List<? extends FieldType> elementTypes) {
        this(elementTypes);
