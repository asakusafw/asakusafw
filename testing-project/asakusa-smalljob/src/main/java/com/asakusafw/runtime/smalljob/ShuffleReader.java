    ...
    public boolean next() throws IOException {
        ...
        try {
            if (source.next()) {
                ...
                keyBuffer.reset(slice.getBytes(), slice.getOffset(), slice.getKeyLength());
                valueBuffer.reset(slice.getBytes(), slice.getOffset() + slice.getKeyLength(), slice.getValueLength());
                prepared = true;
            } else {
                prepared = false;
            }
