...
/**
 * Service provider interface of {@link DifferenceSink} drivers.
 * <p>
 * Adding test data sources, clients can implement this
 * and put the class name in
 * {@code META-INF/services/com.asakusafw.testdriver.core.DifferenceSinkProvider}.
 * </p>
 * @since 0.2.3
 */
@FunctionalInterface
public interface DifferenceSinkProvider {

    /**
     * Creates a {@link DifferenceSink} object corresponding to the specified URI.
     * <p>
     ...
     * @return the created {@link DifferenceSink},
     *     or {@code null} if the specified source is not valid for this object
     * @throws IOException if failed to create a {@link DifferenceSink} from the URI
     * @throws IllegalArgumentException if some parameters were {@code null}
     */
    <T> DifferenceSink create(
