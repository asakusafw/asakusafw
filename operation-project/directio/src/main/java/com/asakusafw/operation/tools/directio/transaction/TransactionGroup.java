...
public class TransactionGroup extends GroupUsageCommand implements CommandProvider {
    ...
    public void accept(CommandBuilder<Runnable> builder) {
        builder.addGroup(new TransactionGroup(), flattern()::accept);
    }
    ...
    public CommandProvider flattern() {
        return builder -> builder
                .addCommand(new TransactionShowCommand())
                .addCommand(new TransactionListCommand())
                .addCommand(new TransactionApplyCommand())
                .addCommand(new TransactionAbortCommand());
    }
}
