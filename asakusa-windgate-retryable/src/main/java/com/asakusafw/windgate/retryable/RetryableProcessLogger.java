 ...
 * @since 0.2.4
 */
public class RetryableProcessLogger extends WindGateLogger {

    private static final ResourceBundle BUNDLE = ResourceBundle.getBundle("com.asakusafw.windgate.retryable.log"); //$NON-NLS-1$
     ...
     */
    public RetryableProcessLogger(Class<?> target) {
        super(target, "RETRYABLE");
    }
