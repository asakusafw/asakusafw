...
/**
 * テーブル<code>foo</code>を表すモデルクラス。
 */
@TableModel(name = "foo", primary = {})@Generated("TableModelEntityEmitter")@SuppressWarnings("deprecation") public
     ...
     */
    public void copyFrom(Foo source) {
