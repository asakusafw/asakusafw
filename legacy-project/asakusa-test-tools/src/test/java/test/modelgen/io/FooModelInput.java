 ...
 */
public final class FooModelInput implements ModelInput<Foo> {
    /**
     * 内部で利用するパーサー
     */
     ...
     */
    public FooModelInput(RecordParser parser) {
        if(parser == null) {
            throw new IllegalArgumentException();
        }
        this.parser = parser;
    }
    @Override public boolean readTo(Foo model) throws IOException {
