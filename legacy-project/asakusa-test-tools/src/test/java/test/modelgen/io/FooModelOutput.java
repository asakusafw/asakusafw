 ...
 */
public final class FooModelOutput implements ModelOutput<Foo> {
    /**
     * 内部で利用するエミッター。
     */
     ...
     */
    public FooModelOutput(RecordEmitter emitter) {
        if(emitter == null) {
            throw new IllegalArgumentException();
        }
        this.emitter = emitter;
    }
    @Override public void write(Foo model) throws IOException {
