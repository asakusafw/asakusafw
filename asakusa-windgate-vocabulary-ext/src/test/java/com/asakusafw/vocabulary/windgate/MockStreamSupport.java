...
public abstract class MockStreamSupport<T> implements DataModelStreamSupport<T> {
    ...
    @Override
    public DataModelReader<T> createReader(InputStream stream) throws IOException {
        throw new AssertionError();
    }

    @Override
    public DataModelWriter<T> createWriter(OutputStream stream) throws IOException {
        throw new AssertionError();
    }
}
