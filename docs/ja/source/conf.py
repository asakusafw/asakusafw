...
extlinks = {
    ...
    'apiref': ('http://docs.asakusafw.com/0.7.5/release/api/%s', None),
    'epub': ('http://docs.asakusafw.com/0.7.5/release/ja/epub/%s', None)
}
javadoclinks = {
    'javadoc': ('http://docs.asakusafw.com/0.7.5/release/api/%s.html', ""),
    'gradledoc': ('http://docs.asakusafw.com/0.7.5/release/gradle-plugins/%s.html', "")
}
...
copyright = u'2011-2015, Asakusa Framework Team'
