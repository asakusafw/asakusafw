...
extlinks = {
    ...
    'apiref': ('http://docs.asakusafw.com/0.7.4/release/api/%s', None),
    'epub': ('http://docs.asakusafw.com/0.7.4/release/ja/epub/%s', None)
}
javadoclinks = {
    'javadoc': ('http://docs.asakusafw.com/0.7.4/release/api/%s.html', ""),
    'gradledoc': ('http://docs.asakusafw.com/0.7.4/release/gradle-plugins/%s.html', "")
}
