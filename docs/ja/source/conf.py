...
extlinks = {
    ...
    'apiref': ('http://asakusafw.s3.amazonaws.com/documents/0.7.1/release/api/%s', None),
    'epub': ('http://asakusafw.s3.amazonaws.com/documents/0.7.1/release/ja/epub/%s', None)
}
javadoclinks = {
    'javadoc': ('http://asakusafw.s3.amazonaws.com/documents/0.7.1/release/api/%s.html', ""),
    'gradledoc': ('http://asakusafw.s3.amazonaws.com/documents/0.7.1/release/gradle-plugins/%s.html', "")
}
# ------------------------------------------------------------------------------
