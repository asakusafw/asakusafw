...
extlinks = {
    ...
    'apiref': ('http://docs.asakusafw.com/0.8.2/release/api/%s', None),
    'epub': ('http://docs.asakusafw.com/0.8.2/release/ja/epub/%s', None),
    'basic-tutorial': ('http://docs.asakusafw.com/basic-tutorial/0.8/release/ja/html/%s', None),
}
javadoclinks = {
    'javadoc': ('http://docs.asakusafw.com/0.8.2/release/api/%s.html', ""),
    'gradledoc': ('http://docs.asakusafw.com/0.8.2/release/gradle-plugins/%s.html', "")
}
