...
extlinks = {
    ...
    'apiref': ('http://docs.asakusafw.com/0.7.6/release/api/%s', None),
    'epub': ('http://docs.asakusafw.com/0.7.6/release/ja/epub/%s', None)
}
javadoclinks = {
    'javadoc': ('http://docs.asakusafw.com/0.7.6/release/api/%s.html', ""),
    'gradledoc': ('http://docs.asakusafw.com/0.7.6/release/gradle-plugins/%s.html', "")
}
