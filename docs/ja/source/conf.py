...
javadoclinks = {
    'javadoc': ('http://asakusafw.s3.amazonaws.com/documents/0.6.2/release/api/%s.html', ""),
    'gradledoc': ('http://asakusafw.s3.amazonaws.com/documents/0.6.2/release/gradle-plugins/%s.html', "")
}
# ------------------------------------------------------------------------------
