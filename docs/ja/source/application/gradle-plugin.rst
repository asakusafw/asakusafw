...
* `asakusa-project-template-0.7.6.tar.gz <http://www.asakusafw.com/download/gradle-plugin/asakusa-project-template-0.7.6.tar.gz>`_

Asakusa Gradle Plugin 用サンプルアプリケーションプロジェクト
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

* `asakusa-example-project-0.7.6.tar.gz <http://www.asakusafw.com/download/gradle-plugin/asakusa-example-project-0.7.6.tar.gz>`_
...
..  attention::
    ...
    例えば Asakusa Framework バージョン ``0.7.6`` では ``0.7.6`` のような値となります。
...
..  attention::
    ...
    例えば Asakusa Framework バージョン ``0.7.6`` では ``0.7.6-hadoop1`` のような値となります。
