...
バージョン 0.7.3 へのマイグレーション
-------------------------------------

バージョン 0.7.3 におけるバージョン固有のマイグレーション手順はありません。
各バージョン共通のマイグレーション手順のみを実施してください。

バージョン 0.7.2 へのマイグレーション
-------------------------------------

バージョン 0.7.2 におけるバージョン固有のマイグレーション手順はありません。
各バージョン共通のマイグレーション手順のみを実施してください。
...
MavenプロジェクトからGradleプロジェクトへのマイグレーション手順については、 `Mavenプロジェクトのマイグレーション`_ を参照してください。
