...
例えば、Asakusa Frameworkのバージョン ``0.6.2`` のHadoop2系向けバージョンは、
``0.6.2-hadoop2`` となります。
...
以下は、Asakusa Framework のバージョン ``0.6.2`` のHadoop2系向け
...
Hadoop2系向けデプロイメントアーカイブ(例えば ``asakusafw-0.6.2-hadoop2-prod-windgate.tar.gz`` )
が作成されます。
