...
/**
 * テーブル<code>purchase_tran</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "purchase_tran", columns = {"SID", "VERSION_NO",
            "RGST_DATETIME", "UPDT_DATETIME", "PURCHASE_NO", "PURCHASE_TYPE", "TRADE_TYPE", "TRADE_NO", "LINE_NO",
            "DELIVERY_DATE", "STORE_CODE", "BUYER_CODE", "PURCHASE_TYPE_CODE", "SELLER_CODE", "TENANT_CODE",
        ...
        "deprecation") public class PurchaseTran implements Writable {
    /**
     ...
     */
    public void copyFrom(PurchaseTran source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        PurchaseTran other = (PurchaseTran) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=purchase_tran");
        result.append(", sid=");
