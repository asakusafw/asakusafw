 ...
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "export_temp_import_target1_1_df", columns = {
            "TEMP_SID"}, primary = {"TEMP_SID"})@SuppressWarnings("deprecation") public class ExportTempImportTarget11Df
        implements Writable {
    /**
     ...
     */
    public void copyFrom(ExportTempImportTarget11Df source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        ExportTempImportTarget11Df other = (ExportTempImportTarget11Df) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=export_temp_import_target1_1_df");
