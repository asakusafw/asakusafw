...
/**
 * テーブル<code>import_target1</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "import_target1", columns = {"SID", "VERSION_NO"
     ...
     */
    public void copyFrom(ImportTarget1 source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        ImportTarget1 other = (ImportTarget1) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=import_target1");
        result.append(", sid=");
