...
@Generated("ModelOutputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class
        ExportTempPurchaseTran1ModelOutput implements ModelOutput<ExportTempPurchaseTran1> {
    /**
     * 内部で利用するエミッター。
     */
     ...
     */
    public ExportTempPurchaseTran1ModelOutput(RecordEmitter emitter) {
        if(emitter == null) {
            throw new IllegalArgumentException();
        }
        this.emitter = emitter;
    }
    @Override public void write(ExportTempPurchaseTran1 model) throws IOException {
