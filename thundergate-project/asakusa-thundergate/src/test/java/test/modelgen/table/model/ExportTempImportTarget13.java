...
/**
 * テーブル<code>export_temp_import_target1_3</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "export_temp_import_target1_3", columns = {
            "VERSION_NO", "TEMP_SID", "SID", "UPDT_DATE", "DUPLICATE_FLG", "TEXTDATA1", "INTDATA1", "DATEDATA1"},
        primary = {"tempSid"})@SuppressWarnings("deprecation") public class ExportTempImportTarget13 implements Writable
        {
    /**
     ...
     */
    public void copyFrom(ExportTempImportTarget13 source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        ExportTempImportTarget13 other = (ExportTempImportTarget13) obj;
