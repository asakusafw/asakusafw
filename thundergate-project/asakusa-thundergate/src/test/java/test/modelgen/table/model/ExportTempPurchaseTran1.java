 ...
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "export_temp_purchase_tran_1", columns = {
            "__TEMP_SID", "SID", "VERSION_NO", "RGST_DATETIME", "UPDT_DATETIME", "PURCHASE_NO", "PURCHASE_TYPE",
            "TRADE_TYPE", "TRADE_NO", "LINE_NO", "DELIVERY_DATE", "STORE_CODE", "BUYER_CODE", "PURCHASE_TYPE_CODE",
            "SELLER_CODE", "TENANT_CODE", "NET_PRICE_TOTAL", "SELLING_PRICE_TOTAL", "SHIPMENT_STORE_CODE",
            "SHIPMENT_SALES_TYPE_CODE", "DEDUCTION_CODE", "ACCOUNT_CODE", "OWNERSHIP_DATE", "CUTOFF_DATE", "PAYOUT_DATE"
            , "OWNERSHIP_FLAG", "CUTOFF_FLAG", "PAYOUT_FLAG", "DISPOSE_NO", "DISPOSE_DATE"}, primary = {"__TEMP_SID"})@
        SuppressWarnings("deprecation") public class ExportTempPurchaseTran1 implements Writable {
    /**
     * カラム<code>__TEMP_SID</code>を表すフィールド。
     */
    @Property(name = "__TEMP_SID") private LongOption tempSid = new LongOption();
    /**
    ...
    /**
     * カラム<code>__TEMP_SID</code>の値を返す。
     * @return カラム<code>__TEMP_SID</code>の値
    ...
    /**
     * カラム<code>__TEMP_SID</code>の値を変更する。
     * @param tempSid 設定する値
     */
     ...
     */
    public void copyFrom(ExportTempPurchaseTran1 source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        ExportTempPurchaseTran1 other = (ExportTempPurchaseTran1) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=export_temp_purchase_tran_1");
