 ...
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "export_temp_import_target1_9", columns = {
            "TEMP_SID", "SID", "VERSION_NO", "RGST_DATE", "UPDT_DATE", "DUPLICATE_FLG", "TEXTDATA1", "INTdata2",
            "DATEdata2"}, primary = {"tempSid"})@SuppressWarnings("deprecation") public class ExportTempImportTarget19
        implements Writable {
    /**
     ...
     */
    public void copyFrom(ExportTempImportTarget19 source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        ExportTempImportTarget19 other = (ExportTempImportTarget19) obj;
