...
/**
 * {@link ExportTempImportTarget21}をTSV形式で書きだす
 */
@Generated("ModelOutputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class
        ExportTempImportTarget21ModelOutput implements ModelOutput<ExportTempImportTarget21> {
    /**
     * 内部で利用するエミッター。
     */
     ...
     */
    public ExportTempImportTarget21ModelOutput(RecordEmitter emitter) {
        if(emitter == null) {
            throw new IllegalArgumentException();
        }
        this.emitter = emitter;
    }
    @Override public void write(ExportTempImportTarget21 model) throws IOException {
