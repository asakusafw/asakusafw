...
/**
 * {@link PurchaseTranError2}をTSVなどのレコード形式で出力する。
 */
@Generated("ModelOutputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class PurchaseTranError2ModelOutput
        implements ModelOutput<PurchaseTranError2> {
    /**
     * 内部で利用するエミッター。
     */
     ...
     */
    public PurchaseTranError2ModelOutput(RecordEmitter emitter) {
        if(emitter == null) {
            throw new IllegalArgumentException();
        }
        this.emitter = emitter;
    }
    @Override public void write(PurchaseTranError2 model) throws IOException {
