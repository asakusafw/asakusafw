...
/**
 * TSVファイルなどのレコードを表すファイルを入力として{@link ExportTempImportTarget13}を読み出す。
 */
@Generated("ModelInputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class
        ExportTempImportTarget13ModelInput implements ModelInput<ExportTempImportTarget13> {
    /**
     * 内部で利用するパーサー
     */
     ...
     */
    public ExportTempImportTarget13ModelInput(RecordParser parser) {
        if(parser == null) {
            throw new IllegalArgumentException();
        }
        this.parser = parser;
    }
    @Override public boolean readTo(ExportTempImportTarget13 model) throws IOException {
