...
/**
 * {@link ImportTarget2Error}をTSVなどのレコード形式で出力する。
 */
@Generated("ModelOutputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class ImportTarget2ErrorModelOutput
        implements ModelOutput<ImportTarget2Error> {
    /**
     * 内部で利用するエミッター。
     */
     ...
     */
    public ImportTarget2ErrorModelOutput(RecordEmitter emitter) {
        if(emitter == null) {
            throw new IllegalArgumentException();
        }
        this.emitter = emitter;
    }
    @Override public void write(ImportTarget2Error model) throws IOException {
