...
/**
 * {@link PurchaseTranError}をTSVなどのレコード形式で出力する。
 */
@Generated("ModelOutputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class PurchaseTranErrorModelOutput
        implements ModelOutput<PurchaseTranError> {
    /**
     * 内部で利用するエミッター。
     */
     ...
     */
    public PurchaseTranErrorModelOutput(RecordEmitter emitter) {
        if(emitter == null) {
            throw new IllegalArgumentException();
        }
        this.emitter = emitter;
    }
    @Override public void write(PurchaseTranError model) throws IOException {
