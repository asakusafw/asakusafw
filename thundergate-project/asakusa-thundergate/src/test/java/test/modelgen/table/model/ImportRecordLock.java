...
/**
 * テーブル<code>import_record_lock</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "import_record_lock", columns = {"JOBFLOW_SID",
            "TABLE_NAME"}, primary = {"JOBFLOW_SID", "TABLE_NAME"})@SuppressWarnings("deprecation") public class
        ImportRecordLock implements Writable {
    /**
     ...
     */
    public void copyFrom(ImportRecordLock source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        ImportRecordLock other = (ImportRecordLock) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=import_record_lock");
