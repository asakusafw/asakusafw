...
/**
 * {@link Temp7}をTSVなどのレコード形式で出力する。
 */
@Generated("ModelOutputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class Temp7ModelOutput implements
        ModelOutput<Temp7> {
    /**
     * 内部で利用するエミッター。
     */
     ...
     */
    public Temp7ModelOutput(RecordEmitter emitter) {
        if(emitter == null) {
            throw new IllegalArgumentException();
        }
        this.emitter = emitter;
    }
    @Override public void write(Temp7 model) throws IOException {
