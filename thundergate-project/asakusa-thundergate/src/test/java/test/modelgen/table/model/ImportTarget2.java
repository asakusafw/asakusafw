...
/**
 * テーブル<code>import_target2</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "import_target2", columns = {"SID", "VERSION_NO"
            , "TEXTDATA2", "INTDATA2", "DATEDATA2", "RGST_DATE", "UPDT_DATE"}, primary = {"SID"})@SuppressWarnings(
        "deprecation") public class ImportTarget2 implements Writable {
    /**
     ...
     */
    public void copyFrom(ImportTarget2 source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        ImportTarget2 other = (ImportTarget2) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=import_target2");
        result.append(", sid=");
