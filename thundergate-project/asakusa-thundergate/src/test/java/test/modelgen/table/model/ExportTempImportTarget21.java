...
/**
 * テーブル<code>export_temp_import_target2_1</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "export_temp_import_target2_1", columns = {
            "TEMP_SID", "SID", "VERSION_NO", "RGST_DATE", "UPDT_DATE", "DUPLICATE_FLG", "TEXTDATA2", "INTDATA2",
            "DATEDATA2"}, primary = {"tempSid"})@SuppressWarnings("deprecation") public class ExportTempImportTarget21
        implements Writable {
    /**
     ...
     */
    public void copyFrom(ExportTempImportTarget21 source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        ExportTempImportTarget21 other = (ExportTempImportTarget21) obj;
