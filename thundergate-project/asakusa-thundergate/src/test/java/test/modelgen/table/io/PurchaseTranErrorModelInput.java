...
import test.modelgen.table.model.PurchaseTranError;

import com.asakusafw.runtime.io.ModelInput;
import com.asakusafw.runtime.io.RecordParser;
/**
 * TSVファイルなどのレコードを表すファイルを入力として{@link PurchaseTranError}を読み出す。
 */
@Generated("ModelInputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class PurchaseTranErrorModelInput
        implements ModelInput<PurchaseTranError> {
    /**
     * 内部で利用するパーサー
     */
     ...
     */
    public PurchaseTranErrorModelInput(RecordParser parser) {
        if(parser == null) {
            throw new IllegalArgumentException();
        }
        this.parser = parser;
    }
    @Override public boolean readTo(PurchaseTranError model) throws IOException {
