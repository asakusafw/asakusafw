...
/**
 * テーブル<code>temp_7</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "temp_7", columns = {"TEMP_SID", "SID",
            "VERSION_NO", "TEXTDATA2", "INTDATA2", "DATEDATA2", "RGST_DATE", "UPDT_DATE", "DUPLICATE_FLG"}, primary = {
            "TEMP_SID"})@SuppressWarnings("deprecation") public class Temp7 implements Writable {
    /**
     ...
     */
    public void copyFrom(Temp7 source) {
