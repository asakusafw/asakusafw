...
import test.modelgen.table.model.PurchaseTranError2;

import com.asakusafw.runtime.io.ModelInput;
import com.asakusafw.runtime.io.RecordParser;
/**
 * TSVファイルなどのレコードを表すファイルを入力として{@link PurchaseTranError2}を読み出す。
 */
@Generated("ModelInputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class PurchaseTranError2ModelInput
        implements ModelInput<PurchaseTranError2> {
    /**
     * 内部で利用するパーサー
     */
     ...
     */
    public PurchaseTranError2ModelInput(RecordParser parser) {
        if(parser == null) {
            throw new IllegalArgumentException();
        }
        this.parser = parser;
    }
    @Override public boolean readTo(PurchaseTranError2 model) throws IOException {
