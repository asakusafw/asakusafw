...
/**
 * テーブル<code>purchase_tran_error2</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "purchase_tran_error2", columns = {"SID",
            ...
            "CUTOFF_FLAG", "PAYOUT_FLAG", "DISPOSE_NO", "DISPOSE_DATE", "ERROR_CAUSE", "ERROR_CODE"}, primary = {"SID"})
        @SuppressWarnings("deprecation") public class PurchaseTranError2 implements Writable {
    /**
     ...
     */
    public void copyFrom(PurchaseTranError2 source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        PurchaseTranError2 other = (PurchaseTranError2) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=purchase_tran_error2");
        result.append(", sid=");
