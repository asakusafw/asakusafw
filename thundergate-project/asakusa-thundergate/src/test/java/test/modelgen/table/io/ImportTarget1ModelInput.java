...
/**
 * TSVファイルなどのレコードを表すファイルを入力として{@link ImportTarget1}を読み出す。
 */
@Generated("ModelInputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class ImportTarget1ModelInput
        implements ModelInput<ImportTarget1> {
    /**
     * 内部で利用するパーサー
     */
     ...
     */
    public ImportTarget1ModelInput(RecordParser parser) {
        if(parser == null) {
            throw new IllegalArgumentException();
        }
        this.parser = parser;
    }
    @Override public boolean readTo(ImportTarget1 model) throws IOException {
