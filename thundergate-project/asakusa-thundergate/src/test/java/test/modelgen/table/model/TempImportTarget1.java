...
/**
 * テーブル<code>temp_import_target1</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "temp_import_target1", columns = {"TEMP_SID",
            "SID", "VERSION_NO", "TEXTDATA1", "INTDATA1", "DATEDATA1", "RGST_DATE", "UPDT_DATE", "DUPLICATE_FLG"},
        primary = {"TEMP_SID"})@SuppressWarnings("deprecation") public class TempImportTarget1 implements Writable {
    /**
     ...
     */
    public void copyFrom(TempImportTarget1 source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        TempImportTarget1 other = (TempImportTarget1) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=temp_import_target1");
