...
/**
 * テーブル<code>export_temp_import_target1_9_df</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "export_temp_import_target1_9_df", columns = {
            "TEMP_SID"}, primary = {"TEMP_SID"})@SuppressWarnings("deprecation") public class ExportTempImportTarget19Df
        implements Writable {
    /**
     ...
     */
    public void copyFrom(ExportTempImportTarget19Df source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        ExportTempImportTarget19Df other = (ExportTempImportTarget19Df) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=export_temp_import_target1_9_df");
