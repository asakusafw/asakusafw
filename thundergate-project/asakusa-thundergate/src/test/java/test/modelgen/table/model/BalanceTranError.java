...
/**
 * テーブル<code>balance_tran_error</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "balance_tran_error", columns = {"SID",
            "VERSION_NO", "RGST_DATETIME", "UPDT_DATETIME", "SELLER_CODE", "PREVIOUS_CUTOFF_DATE", "CUTOFF_DATE",
            "NEXT_CUTOFF_DATE", "PAYOUT_DATE", "CARRIED", "PURCHASE", "RTN", "DISCOUNT", "TAX", "PAYABLE", "MUTUAL",
            "RESERVES", "CANCEL", "PAYMENT", "NEXT_PURCHASE", "NEXT_RETURN", "NEXT_DISCOUNT", "NEXT_TAX", "ERROR_CODE",
            "PAYMENT_FLAG"}, primary = {})@SuppressWarnings("deprecation") public class BalanceTranError implements
        Writable {
    /**
     ...
     */
    public void copyFrom(BalanceTranError source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        BalanceTranError other = (BalanceTranError) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=balance_tran_error");
        result.append(", sid=");
