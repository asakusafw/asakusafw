...
/**
 * TSVファイルなどのレコードを表すファイルを入力として{@link ExportTempPurchaseTran1}を読み出す。
 */
@Generated("ModelInputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class
        ExportTempPurchaseTran1ModelInput implements ModelInput<ExportTempPurchaseTran1> {
    /**
     * 内部で利用するパーサー
     */
     ...
     */
    public ExportTempPurchaseTran1ModelInput(RecordParser parser) {
        if(parser == null) {
            throw new IllegalArgumentException();
        }
        this.parser = parser;
    }
    @Override public boolean readTo(ExportTempPurchaseTran1 model) throws IOException {
