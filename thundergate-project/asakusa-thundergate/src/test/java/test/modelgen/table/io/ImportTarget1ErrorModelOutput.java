...
/**
 * {@link ImportTarget1Error}をTSVなどのレコード形式で出力する。
 */
@Generated("ModelOutputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class ImportTarget1ErrorModelOutput
        implements ModelOutput<ImportTarget1Error> {
    /**
     * 内部で利用するエミッター。
     */
     ...
     */
    public ImportTarget1ErrorModelOutput(RecordEmitter emitter) {
        if(emitter == null) {
            throw new IllegalArgumentException();
        }
        this.emitter = emitter;
    }
    @Override public void write(ImportTarget1Error model) throws IOException {
