...
/**
 * テーブル<code>temp_import_target1_df</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "temp_import_target1_df", columns = {"TEMP_SID"}
        , primary = {"TEMP_SID"})@SuppressWarnings("deprecation") public class TempImportTarget1Df implements Writable {
    /**
     ...
     */
    public void copyFrom(TempImportTarget1Df source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        TempImportTarget1Df other = (TempImportTarget1Df) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=temp_import_target1_df");
