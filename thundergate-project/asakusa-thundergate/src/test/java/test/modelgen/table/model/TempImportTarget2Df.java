...
/**
 * テーブル<code>temp_import_target2_df</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "temp_import_target2_df", columns = {"TEMP_SID"}
        , primary = {"TEMP_SID"})@SuppressWarnings("deprecation") public class TempImportTarget2Df implements Writable {
    /**
     ...
     */
    public void copyFrom(TempImportTarget2Df source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        TempImportTarget2Df other = (TempImportTarget2Df) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=temp_import_target2_df");
