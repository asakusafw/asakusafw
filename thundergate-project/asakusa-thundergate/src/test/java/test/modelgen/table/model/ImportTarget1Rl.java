...
/**
 * テーブル<code>import_target1_rl</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "import_target1_rl", columns = {"SID",
            "JOBFLOW_SID"}, primary = {"SID"})@SuppressWarnings("deprecation") public class ImportTarget1Rl implements
        Writable {
    /**
     ...
     */
    public void copyFrom(ImportTarget1Rl source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        ImportTarget1Rl other = (ImportTarget1Rl) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=import_target1_rl");
        result.append(", sid=");
