...
/**
 * テーブル<code>export_temp_purchase_tran_1_df</code>を表すモデルクラス。
 */
@Generated("TableModelEntityEmitter:0.0.1")@DataModel@TableModel(name = "export_temp_purchase_tran_1_df", columns = {
            "__TEMP_SID"}, primary = {"__TEMP_SID"})@SuppressWarnings("deprecation") public class
        ExportTempPurchaseTran1Df implements Writable {
    /**
     ...
     */
    public void copyFrom(ExportTempPurchaseTran1Df source) {
    ...
    @Override public boolean equals(Object obj) {
        ...
        ExportTempPurchaseTran1Df other = (ExportTempPurchaseTran1Df) obj;
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=export_temp_purchase_tran_1_df");
