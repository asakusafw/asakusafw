...
/**
 * {@link BalanceTran}をTSVなどのレコード形式で出力する。
 */
@Generated("ModelOutputEmitter:0.0.1")@SuppressWarnings("deprecation") public final class BalanceTranModelOutput
        implements ModelOutput<BalanceTran> {
    /**
     * 内部で利用するエミッター。
     */
     ...
     */
    public BalanceTranModelOutput(RecordEmitter emitter) {
        if(emitter == null) {
            throw new IllegalArgumentException();
        }
        this.emitter = emitter;
    }
    @Override public void write(BalanceTran model) throws IOException {
